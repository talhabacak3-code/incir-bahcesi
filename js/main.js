...
(function () {
  ...
  var products = [
    ...
    { name: 'Kuru Erik',          emoji: '🟣', tag: 'Doğal kuru erik',                img: IMG + 'kuru-erik.webp' },
    { name: 'Dut Kurusu',         emoji: '🌾', tag: 'Beyaz dut kurusu',               img: IMG + 'dut-kurusu.webp' },
    { name: 'İğde',               emoji: '🟠', tag: 'Yöresel iğde',                    img: IMG + 'igde.webp' },
    { name: 'İğde Tozu',          emoji: '🥄', tag: 'Öğütülmüş iğde tozu',            img: IMG + 'igde-tozu.webp' },
    { name: 'Hünnap',             emoji: '🔴', tag: 'Kurutulmuş hünnap',              img: IMG + 'hunnap.webp' },
    { name: 'Tarhana',            emoji: '🥣', tag: 'Ev yapımı tarhana',              img: IMG + 'tarhana.webp' },
    { name: 'Afyon Ekmeği',       emoji: '🍞', tag: 'Meşhur Afyon ekmeği',            img: IMG + 'afyon-ekmegi.webp' },
    { name: 'Sucuk',              emoji: '🥩', tag: 'Afyon sucuğu',                    img: IMG + 'sucuk.webp' },
    { name: 'Kaymak',             emoji: '🥛', tag: 'Meşhur Afyon kaymağı',           img: IMG + 'kaymak.webp' },
    { name: 'Yaprak',             emoji: '🍃', tag: 'Taze asma yaprağı',              img: IMG + 'yaprak.webp' },
    { name: 'Kadir Zade Meyve Özleri', emoji: '🍯', tag: 'Doğal meyve özleri',        img: IMG + 'meyve-ozleri.webp' },
    { name: 'Kurular',            emoji: '🧺', tag: 'Çeşitli kuru gıdalar',           img: IMG + 'kurular.webp' }
  ];
